...
public interface SysMenuService {
    ...
    List<SysMenu> getAllMenus(String authority);
    /**
     * 修改菜单
     * @param sysMenu 菜单
     * @return 返回值
     ...
     * @return sysMenu
     **/
    SysMenu getByHref(String menuHref);

    /*
     * 根据查询的名称模糊查询
     * @Date 2020/5/30 19:45
     * @Param menuName 菜单名称,page 分页对象
     * @return 菜单集合
     **/
    IPage<SysMenu> searchMenu(Page page,String menuName);
     ...
     * @return
     **/
    int updateShow(String id,String stat);
