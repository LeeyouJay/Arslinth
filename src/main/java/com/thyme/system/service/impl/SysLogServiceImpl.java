...
public class SysLogServiceImpl implements SysLogService {
    ...
    @Override
    public List<SysLog> findSysLogPage(SysLogVO sysLogVO) {
        return sysLogDao.findSysLogPage(sysLogVO.getStart(),sysLogVO.getEnd(),sysLogVO.getUsername());
    }

    @Override
    public int deleteSysLogByIds(List<String> ids) {
