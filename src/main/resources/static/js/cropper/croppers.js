...
layui.config({
    base: '/Arslinth/static/js/cropper/' 
}).define(['jquery','layer','cropper'],function (exports) {
    var $ = layui.jquery
        ,layer = layui.layer;
    var html = "<link rel=\"stylesheet\" href=\"/Arslinth/static/js/cropper/cropper.css\">\n" +
        ...
        "        </div>\n" +
        "        <div class=\"layui-form-mid layui-word-aux\">头像的尺寸限定200x200px,大小在1MB以内</div>\n" +
        "    </div>\n" +
        ...
        "        </div>\n" +
        "        <div class=\"layui-col-xs3\">\n" +
        "            <button class=\"layui-btn layui-btn-fluid\" cropper-event=\"confirmSave\" type=\"button\"> 提交修改</button>\n" +
        "        </div>\n" +
        "    </div>\n" +
        "\n" +
        "</div>";
                    ...
                    image.cropper("getCroppedCanvas",{
                        ...
                        $.ajax({
                            ...
                            success:function(result){
                                if(result.code == 200){
                                    layer.closeAll();
                                    return done(result.data.src,result.data.msg);
                                }else{
